...
•	default: 같은 패키지안에서만 접근 가능, 아무것도 안 적으면 기본값으로 적용
...
•	abstract 클래스: 추상 메서드를 가진 클래스 / 인스턴스를 사용할 수 없다.
...
•	implements(시행하다): interface를 해당 키워드를 통해 구현

•	this: 현재 인스턴스의 참조, 주로 필드와 지역변수를 구분하서나, 생성자에서 다른 생성을 
