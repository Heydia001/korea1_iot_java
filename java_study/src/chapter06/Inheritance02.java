...
// 상속에서의 생성자
// : 상속받은 클래스에서 생성자 호출 예시
// >> 부모 - 자식 순서로 진행

// 자식클래스의 객체를 생성할 때, 자식클래스는 자식 생성자를 통해 자식 객체를 생성
// 자식 클래스의 생성자 호출 시 항상 부모 클래스의샐설자를 호출
...
class Cat extends Mammal {
	...
	Cat(String name){
		...
		// : 기본 생성자 또는 생성자 정의 생성자의 형태 그대로를 사용
